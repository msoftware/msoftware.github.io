...
final class JavascriptEvaluation {
  ...
  private static final class ScriptPreparer implements Function<UnpreparedScript, PreparedScript> {
    ...
    private StringBuilder atomize(
      ...
      int guessedSize = EvaluationAtomLsc.EXECUTE_SCRIPT_ANDROID.length() + script.length() + 1024;
      if (windowReference != null) {
        guessedSize += EvaluationAtomLsc.GET_ELEMENT_ANDROID.length();
      }
      StringBuilder toExecute = new StringBuilder(guessedSize).append("var my_wind = ");
      if (windowReference != null) {
        toExecute
            .append("(")
            .append(EvaluationAtomLsc.GET_ELEMENT_ANDROID)
            .append(")(")
      ...
      toExecute.append("return (").append(EvaluationAtomLsc.EXECUTE_SCRIPT_ANDROID).append(")(");
